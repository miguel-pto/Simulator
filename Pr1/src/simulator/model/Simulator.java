...
public class Simulator implements JSONable, Observable<EcoSysObserver> {
	...
	private void set_region(int row, int col, Region r) {
		...
		notify_onRegionSet(row, col, r);
	}

	// CREA UNA REGION DESDE UN JSON Y LLAMA A LA FUNCIÓN ANTERIOR PARA QUE SEA
	// FIJADA
	...
	// LLAMA A LA LISTA Y AL MANAGER PARA QUE AÑADE Y REGISTRE EL ANIMAL
	// PROPORCIONADO
	...
	// CREA UN ANIMAL DESDE UN JSON Y LLAMA A LA FUNCIÓN ANTERIOR PARA QUE SEA
	// AÑADIDO
	...
	// RECORRE TODOS LOS ANIMALES DE LA LISTA Y EN CADA UNO DE ELLOS ACTUALIZA SU
	// RESPECTIVA REGIÓN
	...
	// RECORRE TODOS LOS ANIMALES DE LA LISTA Y SI SE ENCUENTRAN PREÑADOS LLAMAN A
	// DAR A LUZ Y A AÑADIR A SU CRIA
	...
	// FUNCIÓN ENCARGADA DE AVANZAR EL TIEMPO, ELIMINAR LOS MUERTOS, ACTUALIZAR LAS
	// REGIONES Y QUE LOS ANIMALES DEN A LUZ
	...
	@Override
	// CREA UN JSON Y LO DEVUELVE TRAS INTRODUCIRLE INFORMACIÓN DEL TIEMPO Y EL
	// ESTADO DEL REGION MANAGER
	...
	// VACÍA LA LISTA DE ANIMALES CREANDO UNA NUEVA, CREA UN REGIONMANAGER DEL
	// TAMAÑO ADECUADO Y PONE TIEMPO A 0
