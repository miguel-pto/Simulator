...
public class StatusBar extends JPanel implements EcoSysObserver {
	...
	// LA BARRA DE ESTADO ES LA RESPONSABLE DE MOSTRAR LA INFORMACIÓN GENERAL SOBRE
	// EL SIMULADOR
	// INCLUYE INFORMACIÓN SOBRE EL TIEMPO DE SIMULACIÓN, LA CANTIDAD DE ANIMALES,
	// LA DIMENSIÓN DE LA SIMULACIÓN...
	...
	public void onAnimalAdded(double time, MapInfo map, List<AnimalInfo> animals) {
		// SE ESTABLECE LOS ANIMALES DESDE EL ARGUMENTO Y SE ACTUALIZAN LOS TEXTOS DE
		// LOS ATRIBUTOS
		this.animals = animals.size();
		update_labels();
	}
	...
	public void onRegionSet(int row, int col, MapInfo map, RegionInfo r) {
		// SE ESTABLECEN LAS DIMENSIONES DESDE EL ARGUMENTO Y SE ACTUALIZAN LOS TEXTOS
		// DE LOS ATRIBUTOS
		width = map.get_width();
		height = map.get_height();
		rows = map.get_rows();
	...
	public void onAdvanced(double time, MapInfo map, List<AnimalInfo> animals, double dt) {
		// SE ESTABLECE EL TIEMPO DESDE EL ARGUMENTO Y SE ACTUALIZAN LOS TEXTOS DE LOS
		// ATRIBUTOS
		this.time = time;
		update_labels();
	}
