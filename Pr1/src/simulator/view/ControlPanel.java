...
public class ControlPanel extends JPanel {
	...
	// EL PANEL DE CONTROL ES EL RESPONSABLE DE LA INTERACCIÓN ENTRE EL USUARIO Y EL
	// SIMULADOR.
	// INCLUYE BOTONES PARA INTERACTUAR CON EL SIMULADOR, UN JSpinner PARA
	// SELECCIONAR LOS
	...
	// INICIALIZA MEDIANTE EL CONTROLER, INICIALIZANDO changeRegionsDialog CON ESTE
	// E INICIALIZANDO LA GUI
	...
	private void initGUI() {
		...
		// AL PULSARLO SE ABRE EL SELECTOR DE FICHEROS PARA ESTABLECER SU ARCHIVO DE
		// ENTRADA
		...
		// AL PULSARLO PERMITE VER LA REPRESENTACIÓN DE LA SIMULACIÓN, PUDIENDO TENER
		...
		runButton.addActionListener((e) -> { // ACCIONES QUE REALIZA EL BOTON
			try {
				double delt_tim = Double.parseDouble(dtField.getText()); // Primero llamamos al delta_time para que no
																			// se active si el contenido no es correcto
		...
		// AL PULSARLO SE DESHABILITAN LOS BOTONES SALVO EL DE STOP Y, EN NUESTRO CASO,
		// EL DE MAP EN CASO DE QUERER ABRIR OTRA IMAGEN
